#!/usr/bin/env node
/**
 * Shio CMS Documentation — PDF Generator
 *
 * Pipeline:
...
const HEADER_HTML = [
  ...
  '<span style="color:#C2410C;font-weight:700;letter-spacing:0.08em;">SHIO CMS</span>',
...
async function mergePDFs(coverBuf, tocBuf, docBuffers, entries, coverPageCount, tocPageCount) {
  ...
  merged.setTitle('Shio CMS Documentation');
  merged.setSubject('Content Management System — v2026.1');
...
async function main() {
  console.log();
  console.log('  ╔══════════════════════════════════════════╗');
  console.log('  ║   Shio CMS — PDF Documentation Builder   ║');
  console.log('  ╚══════════════════════════════════════════╝');
  console.log();
