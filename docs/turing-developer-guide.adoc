...
Customers who prefer the on-premise structure. And you want to have the services installed directly on the servers. It can be used in Development, QA and Production.
