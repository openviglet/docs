...
:page-permalink: /docs/turing/0.3.6/installation-guide/
:imagesdir: ../
:page-pdf: /docs/turing/turing-installation-guide-0.3.6.pdf
:page-product: turing

include::_adoc_includes/turing/0.3.6/installation/preface.adoc[]
