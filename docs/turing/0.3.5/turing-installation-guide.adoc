...
:page-permalink: /docs/turing/0.3.5/installation-guide/
:imagesdir: ../
...
Starting TuringAI v0.3.5-2a5118b using Java 14.0.2 on LEGION with PID 24752 (/appl/viglet/turing/server/viglet-turing.jar started by alexa in /appl/viglet/turing/server)
The following profiles are active: production
Started TuringAI in 12.554 seconds (JVM running for 13.349)
