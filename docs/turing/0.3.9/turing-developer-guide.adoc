...
include::_adoc_includes/turing/0.3.9/api/turing-api-search-with-targeting-rules.adoc[]

include::_adoc_includes/turing/0.3.9/api/turing-api-search-with-group-by.adoc[]

include::_adoc_includes/turing/0.3.9/api/turing-api-search-between-dates.adoc[]
