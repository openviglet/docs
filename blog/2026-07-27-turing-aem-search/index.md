...
search can't get there, because the answer isn't a *page* — it's a *passage*,
...
and 6 bar"*, that's not a semantic-similarity problem — it's a lookup over
...
- [Skills](/turing/skills) — portable, sandboxed capabilities — when an answer
...
2. Read the queries for two weeks. Add [synonyms](/turing/synonyms) for the
   vocabulary mismatches you find — no reindex required.
