...
| **Block BR**: Block AV follow-through — `responseFormat` honoured on the GET search endpoint too (case-insensitive; unknown value 400s) | [rest-api § responseFormat on GET](./rest-api.md#responseformat-on-get) | 🧩 |
