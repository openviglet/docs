...
| **Block AK** — Live Preview prompt diagnostics (flow-aware persona, token/cost metrics, inert-this-turn, cross-segment lint, node picker, replay a real conversation) | [ai-agents § Live Preview & prompt diagnostics](./ai-agents.md#live-preview--prompt-diagnostics) | 🧩 |
