...
<div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
  ...
  <NavCard icon="📚" title="Semantic Navigation" description="Targeting Rules, Spotlights, Merge Providers, Facets and search response structure" href="/turing/semantic-navigation" />
</div>
