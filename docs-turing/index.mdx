...
<div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
  <NavCard icon="🗂️" title="Assets" description="File manager backed by MinIO — upload, organise and train the RAG knowledge base" href="/turing/assets" />
</div>
...
<div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
  ...
  <NavCard icon="🗃️" title="Embedding Stores & Models" description="ChromaDB, PgVector and Milvus backends with embedding model selection" href="/turing/embedding-stores" />
...
<div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
  ...
  <NavCard icon="📚" title="SN Concepts" description="Targeting Rules, Spotlights, Merge Providers, Facets and search response structure" href="/turing/sn-concepts" />
</div>

<SectionLabel>Other</SectionLabel>

<div style={{ display: "grid", gap: "10px", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
  <NavCard icon="📝" title="Release Notes" description="Release history and changelog" href="/turing/release-notes" />
